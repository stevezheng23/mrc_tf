...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        train_example_list = [{
            ...
            "answer_subtype": train_example.answer_subtype,
        ...
        with open(r"D:\Git\Dev\stevezheng23\mrc_tf\data\coqa\v1.0\train-v1.0.processed.json", "w") as file:  
            json.dump(train_example_list, file, indent=2)
    ...
    if FLAGS.do_predict:
        ...
        predict_example_list = [{
            ...
            "answer_subtype": predict_example.answer_subtype,
        ...
        with open(r"D:\Git\Dev\stevezheng23\mrc_tf\data\coqa\v1.0\dev-v1.0.processed.json", "w") as file:  
            json.dump(predict_example_list, file, indent=2)
