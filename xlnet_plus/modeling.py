...
def transformer_xl(inp_k, n_token, n_layer, d_model, n_head,
  ...
  with tf.variable_scope(scope):
    ...
    for i in range(n_layer):
      ...
      intermediate_output = output_g if inp_q is not None else output_h
      intermediate_output = tf.layers.dropout(intermediate_output, dropout, training=is_training)
    ...
    return output, new_mems, lookup_table, intermediate_outputs
